...
type Echo interface {
  // Parameters:
  //  - Req
  Echo(req *EchoRequest) (r *EchoResponse, err error)
}
...
// Parameters:
//  - Req
func (p *EchoClient) Echo(req *EchoRequest) (r *EchoResponse, err error) {
  if err = p.sendEcho(req); err != nil { return }
  return p.recvEcho()
}

func (p *EchoClient) sendEcho(req *EchoRequest)(err error) {
...
func (p *EchoClient) recvEcho() (value *EchoResponse, err error) {
