...
type BaseService interface {
  // Parameters:
  //  - Data
  GetData(ctx context.Context, data *Data) (r *Data, err error)
  // Parameters:
  //  - UID
...
// Parameters:
//  - Data
func (p *BaseServiceClient) GetData(ctx context.Context, data *Data) (r *Data, err error) {
  var _args1 BaseServiceGetDataArgs
  _args1.Data = data
  var _result2 BaseServiceGetDataResult
...
func (p *BaseServiceClient) GetStudentByUID(ctx context.Context, uid string) (r *Student, err error) {
  var _args3 BaseServiceGetStudentByUIDArgs
  _args3.UID = uid
  var _result4 BaseServiceGetStudentByUIDResult
  if err = p.Client_().Call(ctx, "getStudentByUID", &_args3, &_result4); err != nil {
    return
  }
...
func (p *BaseServiceClient) ModifyStudent(ctx context.Context, uid string, form *FormStudent) (r *Student, err error) {
  var _args5 BaseServiceModifyStudentArgs
  _args5.UID = uid
  _args5.Form = form
  var _result6 BaseServiceModifyStudentResult
  if err = p.Client_().Call(ctx, "modifyStudent", &_args5, &_result6); err != nil {
    return
  }
...
func NewBaseServiceProcessor(handler BaseService) *BaseServiceProcessor {
  ...
  self7 := &BaseServiceProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self7.processorMap["getData"] = &baseServiceProcessorGetData{handler:handler}
  self7.processorMap["getStudentByUID"] = &baseServiceProcessorGetStudentByUID{handler:handler}
  self7.processorMap["modifyStudent"] = &baseServiceProcessorModifyStudent{handler:handler}
return self7
}
...
type baseServiceProcessorGetData struct {
  handler BaseService
}

func (p *baseServiceProcessorGetData) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := BaseServiceGetDataArgs{}
  ...
  iprot.ReadMessageEnd()
  result := BaseServiceGetDataResult{}
var retval *Data
  var err2 error
  if retval, err2 = p.handler.GetData(ctx, args.Data); err2 != nil {
...
// Attributes:
//  - Data
type BaseServiceGetDataArgs struct {
  Data *Data `thrift:"data,1" db:"data" json:"data"`
}

func NewBaseServiceGetDataArgs() *BaseServiceGetDataArgs {
  return &BaseServiceGetDataArgs{}
}

var BaseServiceGetDataArgs_Data_DEFAULT *Data
func (p *BaseServiceGetDataArgs) GetData() *Data {
  if !p.IsSetData() {
    return BaseServiceGetDataArgs_Data_DEFAULT
  }
return p.Data
}
func (p *BaseServiceGetDataArgs) IsSetData() bool {
  return p.Data != nil
}

func (p *BaseServiceGetDataArgs) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *BaseServiceGetDataArgs)  ReadField1(iprot thrift.TProtocol) error {
  p.Data = &Data{}
...
func (p *BaseServiceGetDataArgs) Write(oprot thrift.TProtocol) error {
...
func (p *BaseServiceGetDataArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *BaseServiceGetDataArgs) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("BaseServiceGetDataArgs(%+v)", *p)
}

// Attributes:
//  - Success
type BaseServiceGetDataResult struct {
  Success *Data `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewBaseServiceGetDataResult() *BaseServiceGetDataResult {
  return &BaseServiceGetDataResult{}
}

var BaseServiceGetDataResult_Success_DEFAULT *Data
func (p *BaseServiceGetDataResult) GetSuccess() *Data {
  if !p.IsSetSuccess() {
    return BaseServiceGetDataResult_Success_DEFAULT
  }
return p.Success
}
func (p *BaseServiceGetDataResult) IsSetSuccess() bool {
  return p.Success != nil
}

func (p *BaseServiceGetDataResult) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *BaseServiceGetDataResult)  ReadField0(iprot thrift.TProtocol) error {
  p.Success = &Data{}
...
func (p *BaseServiceGetDataResult) Write(oprot thrift.TProtocol) error {
...
func (p *BaseServiceGetDataResult) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
...
func (p *BaseServiceGetDataResult) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("BaseServiceGetDataResult(%+v)", *p)
}
